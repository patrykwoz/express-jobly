...
describe("GET /companies", function () {
  ...
  test("works: filtering by minEmployees only", async function () {
  ...
  test("works: filtering by minEmployees and name", async function () {
    const resp = await request(app).get("/companies").query({ minEmployees: "2", name: "2" });
    expect(resp.body).toEqual({
      companies:
        [
          {
